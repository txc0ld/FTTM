  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 12, border: `2px solid ${BK}`, padding: mobile ? 16 : 24, background: "transparent" }}>
        <div style={{ fontSize: 24, fontWeight: 800, fontFamily: '"VT323", monospace' }}>
      ...
      {globalAudited.length > 0 && (
        <div style={{ marginTop: 24 }}>
          <div style={{ fontSize: 28, fontWeight: 800, fontFamily: '"VT323", monospace', borderBottom: `2px solid ${BK}`, paddingBottom: 12, marginBottom: 24 }}>
            ...
            {globalAudited.map((gnft) => (
              <div key={`g-${gnft.id}`} style={{ border: `3px dashed ${BK}`, padding: 8, background: "rgba(0,0,0,0.02)" }}>
                ...
                <div style={{ textAlign: "center", display: "flex", flexDirection: "column", gap: 4, marginTop: 8 }}>
                  <div style={{ fontSize: 24, fontWeight: 800, fontFamily: '"VT323", monospace' }}>#{gnft.id}</div>
            ...
            {sorted.map((nft) => (
              ...
              >
                ...
                <div style={{ textAlign: "center", display: "flex", flexDirection: "column", gap: 4 }}>
                  <div style={{ fontSize: mobile ? 18 : 24, fontWeight: 800, fontFamily: '"VT323", monospace' }}>
                    #{nft.id}
                  </div>
